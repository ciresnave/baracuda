# Phase 58 (alpha.58) retry script — handles dev-dep cycles by stripping
# `baracuda-*` lines from `[dev-dependencies]` sections.
# Based on publish_alpha54_retry.ps1 pattern.
#
...
$logFile = "target/publish_alpha58_retry.log"
Add-Content -Path $logFile -Value "`n=== alpha.58 publish retry started $(Get-Date) ==="
