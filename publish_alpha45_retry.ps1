# Phase 30 (alpha.45) retry script — handles dev-dep cycles by stripping
# `baracuda-*` lines from `[dev-dependencies]` sections.
# Note: baracuda-kernels-sys is FIRST in the retry list because Phase 30
...
$logFile = "target/publish_alpha45_retry.log"
