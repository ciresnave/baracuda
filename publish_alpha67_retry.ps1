# alpha.67 publish RETRY.
#
# The alpha.67 topo order in publish_alpha67.ps1 is already correct (no new
...
$logFile = "target/publish_alpha67_retry.log"
New-Item -ItemType Directory -Force -Path "target" | Out-Null
Set-Content -Path $logFile -Value "alpha.67 RETRY run started $(Get-Date)" -NoNewline:$false
