...
**In active development — alpha.25.** Roughly **1630 GPU tests passing**
on an RTX 4070 (sm_89), across **324 binary targets**.
...
```toml
[dependencies]
baracuda-kernels = { version = "0.0.1-alpha.25", features = ["sm89", "cudnn"] }
baracuda-driver  = "0.0.1-alpha.25"
```
