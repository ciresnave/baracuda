...
| 39+ | Fuel 6c.4 Phase 4/4: Indexing scatter/index_add + dtype matrix (~250 syms; may need partial — Tier 1 first); multi-block radix sort. Hopper / Blackwell. 1.0 freeze. | pending (see [`ROADMAP.md`](ROADMAP.md)) |
