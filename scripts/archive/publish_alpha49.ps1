# Phase 22 (alpha.49) publish script.
...
$logFile = "target/publish_alpha49.log"
New-Item -ItemType Directory -Force -Path "target" | Out-Null
Set-Content -Path $logFile -Value "Phase 22 publish run started $(Get-Date)" -NoNewline:$false
