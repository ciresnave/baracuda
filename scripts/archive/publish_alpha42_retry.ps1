# Phase 25 (alpha.42) retry script — handles dev-dep cycles by stripping
# `baracuda-*` lines from `[dev-dependencies]` sections.
# Note: baracuda-kernels-sys is FIRST in the retry list because Phase 25
...
$logFile = "target/publish_alpha42_retry.log"
