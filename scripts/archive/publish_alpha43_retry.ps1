# Phase 28 (alpha.43) retry script — handles dev-dep cycles by stripping
# `baracuda-*` lines from `[dev-dependencies]` sections.
# Note: baracuda-kernels-sys is FIRST in the retry list because Phase 28
...
$logFile = "target/publish_alpha43_retry.log"
