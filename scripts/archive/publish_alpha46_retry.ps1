# Phase 31 (alpha.46) retry script — handles dev-dep cycles by stripping
# `baracuda-*` lines from `[dev-dependencies]` sections.
# Note: baracuda-kernels-sys is FIRST in the retry list because Phase 31
...
$logFile = "target/publish_alpha46_retry.log"
