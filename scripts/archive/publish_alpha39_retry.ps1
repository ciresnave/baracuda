# Phase 22 (alpha.39) retry script — handles dev-dep cycles by stripping
# `baracuda-*` lines from `[dev-dependencies]` sections (per the
# previously-validated pattern at git commit a7c2e88).
...
$logFile = "target/publish_alpha39_retry.log"
