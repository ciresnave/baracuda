# alpha.68 publish script.
#
# Build-system release (CUDA 13.3 / CCCL MSVC fix + CUTLASS version guard +
# cudart link-search + baracuda-build lib\x64 detection fix). No kernel/API
# surface change. See CHANGELOG.md.
#
...
$order = @(
    "baracuda-build", "baracuda-cutlass-sys", "baracuda-types-derive", "baracuda-forge",
    "baracuda-types", "baracuda-core", "baracuda-cutlass-kernels-sys", "baracuda-cuda-sys",
    "baracuda-cufile-sys", "baracuda-cupti-sys", "baracuda-cutensor-sys", "baracuda-cvcuda-sys",
    "baracuda-kernels-sys", "baracuda-nvcomp-sys", "baracuda-nvjitlink-sys", "baracuda-nvml-sys",
    "baracuda-nvrtc-sys", "baracuda-cublas-sys", "baracuda-cudf-sys", "baracuda-cudnn-sys",
    "baracuda-cufft-sys", "baracuda-cufile", "baracuda-cupti", "baracuda-curand-sys",
    "baracuda-cusolver-sys", "baracuda-cusparse-sys", "baracuda-cutensor", "baracuda-cuvs-sys",
    "baracuda-cvcuda", "baracuda-driver", "baracuda-flashinfer-sys", "baracuda-nccl-sys",
    "baracuda-npp-sys", "baracuda-nvcomp", "baracuda-nvimagecodec-sys", "baracuda-nvjitlink",
    "baracuda-nvjpeg-sys", "baracuda-nvml", "baracuda-nvrtc", "baracuda-nvshmem-sys",
    "baracuda-tensorrt-sys", "baracuda-transformer-engine-sys", "baracuda-cublas", "baracuda-cudf",
    "baracuda-cudnn", "baracuda-cufft", "baracuda-curand", "baracuda-cusolver",
    "baracuda-cusparse", "baracuda-cuvs", "baracuda-kernels-types", "baracuda-nccl",
    "baracuda-npp", "baracuda-nvimagecodec", "baracuda-nvjpeg", "baracuda-nvshmem",
    "baracuda-ozimmu-sys", "baracuda-runtime", "baracuda-tensorrt", "baracuda-transformer-engine",
    "baracuda", "baracuda-megatron", "baracuda-optim", "baracuda-ozimmu",
    "baracuda-cutlass", "baracuda-kernels", "baracuda-flashinfer"
)

$logFile = "target/publish_alpha68.log"
New-Item -ItemType Directory -Force -Path "target" | Out-Null
Set-Content -Path $logFile -Value "alpha.68 publish run started $(Get-Date)`n"
