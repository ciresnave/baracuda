# Phase 37 (alpha.52) retry script — handles dev-dep cycles by stripping
# `baracuda-*` lines from `[dev-dependencies]` sections.
# Note: baracuda-kernels-sys is FIRST in the retry list because Phase 37
...
$logFile = "target/publish_alpha52_retry.log"
