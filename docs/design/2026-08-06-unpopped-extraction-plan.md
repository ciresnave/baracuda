...
- **Goldens + `.gitattributes eol=lf`** (`crates/baracuda-kernelgen/src/goldens/*.cu`, PR#12 `d5be1ad8`) — MUST travel with `unpopped`; byte-identity goldens break on Windows without the LF attribute.
