# Phase 33 (alpha.48) retry script — handles dev-dep cycles by stripping
# `baracuda-*` lines from `[dev-dependencies]` sections.
# Note: baracuda-kernels-sys is FIRST in the retry list because Phase 33
...
$logFile = "target/publish_alpha48_retry.log"
