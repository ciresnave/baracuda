# Phase 59 (alpha.59) retry script — handles dev-dep cycles by stripping
# `baracuda-*` lines from `[dev-dependencies]` sections.
# Based on publish_alpha59_retry.ps1 pattern.
#
...
$logFile = "target/publish_alpha59_retry.log"
Add-Content -Path $logFile -Value "`n=== alpha.59 publish retry started $(Get-Date) ==="
