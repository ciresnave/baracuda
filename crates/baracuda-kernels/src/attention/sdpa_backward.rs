    ...
    pub fn run(
        ...
        let status = unsafe {
            if contig {
                ...
                match T::KIND {
                    ElementKind::F32 => {
                        baracuda_kernels_sys::baracuda_kernels_sdpa_backward_f32_strided_run(
                            self.desc.batch_size,
                            self.desc.num_heads,
                            self.desc.query_len,
                            self.desc.key_len,
                    ...
                    ElementKind::F16 => {
                        baracuda_kernels_sys::baracuda_kernels_sdpa_backward_f16_strided_run(
                            self.desc.batch_size,
                            self.desc.num_heads,
                            self.desc.query_len,
                            self.desc.key_len,
                    ...
                    ElementKind::Bf16 => {
                        baracuda_kernels_sys::baracuda_kernels_sdpa_backward_bf16_strided_run(
                            self.desc.batch_size,
                            self.desc.num_heads,
                            self.desc.query_len,
                            self.desc.key_len,
                    ...
                    ElementKind::F64 => {
                        baracuda_kernels_sys::baracuda_kernels_sdpa_backward_f64_strided_run(
                            self.desc.batch_size,
                            self.desc.num_heads,
                            self.desc.query_len,
                            self.desc.key_len,
