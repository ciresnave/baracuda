...
use baracuda_kernels::{
    ElementKind, MaxPool1dPlan, PlanPreference, Pool1dBwArgs, Pool1dDescriptor, Pool1dFwArgs,
...
fn max_pool1d_f32() {
    ...
    let desc = Pool1dDescriptor::new(n, c, l_in, 2, PoolMode::Max, ElementKind::F32);
    let plan =
        MaxPool1dPlan::<f32>::select(&stream, &desc, PlanPreference::default()).expect("sel");
