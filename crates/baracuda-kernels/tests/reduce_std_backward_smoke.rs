...
fn run_case(axis: usize, correction: i32) {
    ...
    let (host_y, expected_dx) = host_std_bw_f32(input_shape, axis, correction, &host_x, &host_dy);
...
fn run_case_f64(axis: usize, correction: i32) {
    ...
    let (host_y, expected_dx) = host_std_bw_f64(input_shape, axis, correction, &host_x, &host_dy);
