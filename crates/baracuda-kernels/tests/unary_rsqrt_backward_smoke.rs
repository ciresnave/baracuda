...
fn rsqrt_backward_f16_3d() {
    ...
    let host_y: Vec<f16> = (0..numel)
        .map(|i| f16::from_f32(((i % 50) as f32) * 0.02 + 0.5))
        .collect();
...
fn rsqrt_backward_bf16_3d() {
    ...
    let host_y: Vec<bf16> = (0..numel)
        .map(|i| bf16::from_f32(((i % 50) as f32) * 0.02 + 0.5))
        .collect();
