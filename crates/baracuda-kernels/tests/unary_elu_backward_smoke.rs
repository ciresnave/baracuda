...
fn elu_backward_f16_3d() {
    ...
    for i in 0..numel {
        ...
        assert!(
            diff <= allow,
            "elu bw f16 @ {i}: got {} exp {} (diff {} > allow {})",
            got_f,
            exp,
            diff,
            allow
...
fn elu_backward_bf16_3d() {
    ...
    for i in 0..numel {
        ...
        assert!(
            diff <= allow,
            "elu bw bf16 @ {i}: got {} exp {} (diff {} > allow {})",
            got_f,
            exp,
            diff,
            allow
