...
use baracuda_kernels::{
    ElementKind, PlanPreference, SsdChunkScanArgs, SsdChunkScanDescriptor, SsdChunkScanPlan,
...
fn ssd_chunk_scan_f32_tiny_matches_cpu_ref() {
    ...
    let y_expected = cpu_ref_ssd_f32(&x_host, &dt_host, &a_host, &b_host, &c_host, b, l, h, d, n);
