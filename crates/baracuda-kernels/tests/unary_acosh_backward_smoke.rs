...
fn acosh_backward_f16_3d() {
    ...
    let host_x: Vec<f16> = (0..numel)
        .map(|i| f16::from_f32(((i % 100) as f32) * 0.039 + 1.1))
        .collect();
...
fn acosh_backward_bf16_3d() {
    ...
    let host_x: Vec<bf16> = (0..numel)
        .map(|i| bf16::from_f32(((i % 100) as f32) * 0.039 + 1.1))
        .collect();
