...
fn silu_backward_f16_3d() {
    ...
    let host_x: Vec<f16> = (0..numel)
        .map(|i| f16::from_f32(((i % 600) as f32) * 0.01 - 3.0))
        .collect();
...
fn silu_backward_bf16_3d() {
    ...
    let host_x: Vec<bf16> = (0..numel)
        .map(|i| bf16::from_f32(((i % 600) as f32) * 0.01 - 3.0))
        .collect();
