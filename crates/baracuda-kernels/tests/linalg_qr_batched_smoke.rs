...
fn qr_batched_complex32_basic() {
    ...
    for bi in 0..b as usize {
        for i in 0..m as usize {
            ...
            assert!(mag > 1e-3, "Complex64 R[{bi}][{i},{i}] near-zero: {diag:?}");
        }
    }
}
...
fn qr_batched_complex64_basic() {
    ...
    let n: i32 = 3;
    let k = m.min(n);
    let a_host: Vec<Complex128> = vec![
        Complex128::new(1.0, 0.5),
        Complex128::new(4.0, -0.2),
        Complex128::new(7.0, 0.1),
        Complex128::new(2.0, -0.3),
        Complex128::new(5.0, 0.4),
        Complex128::new(8.0, -0.5),
        Complex128::new(3.0, 0.2),
        Complex128::new(6.0, -0.1),
        Complex128::new(10.0, 0.3),
        Complex128::new(2.0, 0.0),
        Complex128::new(0.0, 1.0),
        Complex128::new(1.0, 0.0),
        Complex128::new(1.0, -0.5),
        Complex128::new(3.0, 0.0),
        Complex128::new(0.0, 0.5),
        Complex128::new(0.0, 0.0),
        Complex128::new(1.0, 0.2),
        Complex128::new(2.0, -0.1),
    ];
    ...
    plan.run(&stream, Workspace::Borrowed(dev_ws.as_slice_mut()), args)
        .expect("run batched QR Complex128");
    stream.synchronize().expect("sync");
    ...
    for bi in 0..b as usize {
        for i in 0..m as usize {
            ...
            assert!(
                mag > 1e-6,
                "Complex128 R[{bi}][{i},{i}] near-zero: {diag:?}"
            );
        }
    }
}
