...
fn tanh_backward_f16_3d() {
    ...
    let host_y: Vec<f16> = (0..numel)
        .map(|i| f16::from_f32(((i % 199) as f32) * 0.009 - 0.9))
        .collect();
...
fn tanh_backward_bf16_3d() {
    ...
    let host_y: Vec<bf16> = (0..numel)
        .map(|i| bf16::from_f32(((i % 199) as f32) * 0.009 - 0.9))
        .collect();
