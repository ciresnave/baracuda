// CUDA-L2 2048_4096_4096 wrapper. See wrapper_m128.cu for the
// rationale. This file is the BM=128, BN=64, BK=32, Stages=4 variant
// with __launch_bounds__(128, 2) per upstream tuning.
//
// MIT license preserved from upstream `kernels/3090_F32F16F16F32/
// 2048_4096_4096.cu`. © 2025 deepreinforce.ai.
...
namespace baracuda_cuda_l2_m2048 {
...
__global__ void __launch_bounds__(128, 2) kernel(T *Aptr, T *Bptr, T *Dptr, int m, int n, int k) {
...
extern "C" void baracuda_cuda_l2_m2048_launch(const __half *a, const __half *b_col_major,
                                               __half *c, int M, int N, int K,
                                               cudaStream_t stream) {
  baracuda_cuda_l2_m2048::launch<__half, 4, true>(
