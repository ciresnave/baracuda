// baracuda-kernels Phase 3 fanout: binary elementwise sub for FP types.
//
...
// this file supplies the SubFunctor and the per-dtype instantiations.
//
...
// Binary sub functor. Templated on T so the same definition serves
...
BARACUDA_KERNELS_BINARY_POINTWISE_INSTANTIATE(
    binary_sub_f32,
    float,
    baracuda::elementwise::SubFunctor<float>)
...
BARACUDA_KERNELS_BINARY_POINTWISE_INSTANTIATE(
    binary_sub_f16,
    __half,
    baracuda::elementwise::SubFunctor<__half>)
...
BARACUDA_KERNELS_BINARY_POINTWISE_INSTANTIATE(
    binary_sub_bf16,
    __nv_bfloat16,
    baracuda::elementwise::SubFunctor<__nv_bfloat16>)
...
BARACUDA_KERNELS_BINARY_POINTWISE_INSTANTIATE(
    binary_sub_f64,
    double,
    baracuda::elementwise::SubFunctor<double>)
