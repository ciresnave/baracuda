// baracuda-kernels Phase 3 unary backward: acos backward.
//
// Forward: `y = acos(x)`. Backward: `dx = -dy / sqrt(1 - x²)`. Saved-x.
// Domain: strictly `|x| < 1`. f32 uses `sqrtf`; f64 uses `sqrt`;
...
template <>
struct AcosBackwardFunctor<float> {
...
template <>
struct AcosBackwardFunctor<double> {
...
template <>
struct AcosBackwardFunctor<__half> {
...
template <>
struct AcosBackwardFunctor<__nv_bfloat16> {
...
BARACUDA_KERNELS_UNARY_BACKWARD_INSTANTIATE(
    unary_acos_backward_f32, float,
    baracuda::elementwise::AcosBackwardFunctor<float>)

BARACUDA_KERNELS_UNARY_BACKWARD_INSTANTIATE(
    unary_acos_backward_f16, __half,
    baracuda::elementwise::AcosBackwardFunctor<__half>)

BARACUDA_KERNELS_UNARY_BACKWARD_INSTANTIATE(
    unary_acos_backward_bf16, __nv_bfloat16,
    baracuda::elementwise::AcosBackwardFunctor<__nv_bfloat16>)

BARACUDA_KERNELS_UNARY_BACKWARD_INSTANTIATE(
    unary_acos_backward_f64, double,
    baracuda::elementwise::AcosBackwardFunctor<double>)
