...
BARACUDA_KERNELS_ROLL_INSTANTIATE_STRIDED(roll_f32, float)
BARACUDA_KERNELS_ROLL_INSTANTIATE_STRIDED(roll_f16, __half)
BARACUDA_KERNELS_ROLL_INSTANTIATE_STRIDED(roll_bf16, __nv_bfloat16)
BARACUDA_KERNELS_ROLL_INSTANTIATE_STRIDED(roll_f64, double)
