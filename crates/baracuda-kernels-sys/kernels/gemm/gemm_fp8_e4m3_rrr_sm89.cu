...
//
// gemm_fp8_e4m3_rrr_sm89.cu — FP8 E4M3 GEMM with RRR layout, Identity
// epilogue, for sm_89.
//
// Thin instantiation of `baracuda_fp8_rrr_sm89.cuh` with
// `<Fp8Encoding::E4M3, float, Activation::None>`.
...
int32_t baracuda_kernels_gemm_fp8_e4m3_rrr_sm89_run(
...
size_t baracuda_kernels_gemm_fp8_e4m3_rrr_sm89_workspace_size(
    int32_t /*m*/, int32_t /*n*/, int32_t /*k*/
) {
    return 0;
}

int32_t baracuda_kernels_gemm_fp8_e4m3_rrr_sm89_can_implement(
    int32_t m, int32_t n, int32_t k,
    const void * /*a*/, int64_t /*lda*/,
    const void * /*b*/, int64_t /*ldb*/,
    const void * /*c*/, int64_t /*ldc*/,
