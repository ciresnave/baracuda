...
mod tests {
    ...
    #[test]
    fn strided_f32_falls_back_to_scalar() {
        let s = OperandDesc::new(2, &[1024, 1024], &[1, 1024], ElementKind::F32, 256);
        let key = structure_key(OpCategory::BinaryElementwise, &[s, s, s], ArchSku::Sm89);
