# Phase 29 (alpha.44) retry script — handles dev-dep cycles by stripping
# `baracuda-*` lines from `[dev-dependencies]` sections.
# Note: baracuda-kernels-sys is FIRST in the retry list because Phase 29
...
$logFile = "target/publish_alpha44_retry.log"
